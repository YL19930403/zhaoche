...
return [
    ...
    // | OSS设置
    // +----------------------------------------------------------------------
    'ACCESS_KEY_ID' => 'LTAIOYKXlUYZ8pKo',
    'ACCESS_KEY_SECRET' => 'mLMtMpSWiCaBnwJoVd8Far1BmDoVJi',
    ...
    // 异常处理handle类 留空使用 \think\exception\Handle     app\lib\exception\ExceptionHandle
...
/**/   
    'cache'                  => [
        ...
        'path'   => CACHE_PATH,
        // 缓存前缀
        'prefix' => 'a629b2a5eaa9728056b8244ec2524952',
        // 缓存有效期 0表示永久缓存
        'expire' => 1,
    ],
