<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:38:"./template/mobile/new2/cart/index.html";i:1509012676;s:41:"./template/mobile/new2/public/header.html";i:1512896668;s:45:"./template/mobile/new2/public/header_nav.html";i:1506391060;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8" />
                        ...
                        <div class="deleshow fr">
                            ...
                            <div class="prices">
                                ...
                                <div class="plus fr get_mp">
                                    <span class="mp_mp">
                                        <input name="changeQuantity_<?php echo $cart['id']; ?>"  id="changeQuantity_<?php echo $cart['id']; ?>" value="<?php echo $cart['goods_num']; ?>"  class="input-num"/>
                                    </span>
                                </div>
