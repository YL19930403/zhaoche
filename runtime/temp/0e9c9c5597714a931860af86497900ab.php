<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:38:"./template/mobile/new2/user/login.html";i:1512897486;s:41:"./template/mobile/new2/public/header.html";i:1512896668;s:45:"./template/mobile/new2/public/header_nav.html";i:1506391060;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8" />
        ...
        <div class="content30">
            ...
            <?php if(!(empty($first_login) || (($first_login instanceof \think\Collection || $first_login instanceof \think\Paginator ) && $first_login->isEmpty()))): ?>
                <div class="lsu test">
                    ...
                    <img  id="verify_code_img"  style="width: 3.7rem"  src="<?php echo U('Mobile/User/verify'); ?>" onClick="verify()"/>
                </div>
            <?php endif; ?>
            ...
            <div class="signup-find p">
                <div class="note fl">
                    ...
                    <a href="<?php echo U('User/reg',array('mobile'=>'')); ?>"><span>快速注册</span></a>
                </div>
                <div class="note fr">
...
<script type="text/javascript">
    ...
    function submitverify()
    {
        ...
        var data = {username:username,password:pass,referurl:referurl};
        if (codeExist) {
