<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:39:"./template/pc/rainbow/goods/search.html";i:1509951022;s:40:"./template/pc/rainbow/public/header.html";i:1508395266;s:40:"./template/pc/rainbow/public/footer.html";i:1508381260;s:46:"./template/pc/rainbow/public/sidebar_cart.html";i:1506391062;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
...
<div class="search-box p">
	<div class="w1430">
		<div class="search-path fl">
			<a href="<?php echo U('Home/Goods/search',array('q'=>$filter_param['q'])); ?>">搜索结果</a>
			<i class="litt-xyb"></i>
		...
		<div class="tjhot fl">
			...
			<div class="tjhot-shoplist" id="ajax_hot_goods">
                <?php
                                ...
                                $md5_key = md5("select * from `__PREFIX__goods` where  is_recommend = 1 and is_on_sale = 1 limit 5");
                                $result_name = $sql_result_vo = S("sql_".$md5_key);
                                if(empty($sql_result_vo))
                                {                            
                                    $result_name = $sql_result_vo = \think\Db::query("select * from `__PREFIX__goods` where  is_recommend = 1 and is_on_sale = 1 limit 5"); 
						...
						<li>
							<div class="s_xsall">
								...
								<div class="J_btn_statu">
									...
									<div class="p-btn">
										<a href="javascript:void(0);" onclick="AjaxAddCart(<?php echo $v[goods_id]; ?>,$('#number_'+<?php echo $v['goods_id']; ?>).val(),1);">直接购买</a>
									</div>
								</div>
							</div>
						</li>
